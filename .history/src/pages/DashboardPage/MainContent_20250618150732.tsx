...
const MainContent: React.FC<MainContentProps> = ({
  ...
  return (
    <section className="flex-grow basis-2/5 bg-gradient-to-b from-slate-900/20 to-black/40 rounded-2xl overflow-hidden p-4 border border-[#00d9ff]/15 shadow-[0_0_40px_rgba(0,217,255,0.08),inset_0_1px_0_rgba(255,255,255,0.05)] backdrop-blur-md relative flex flex-col gap-4">
      {/* 上方区域 - 地球仪 */}
      <div
        ref={globeContainerRef}
        className="flex-grow bg-gradient-to-b from-slate-800/15 to-black/30 rounded-xl relative overflow-hidden border border-[#00d9ff]/10 shadow-[0_0_30px_rgba(0,217,255,0.06),inset_0_1px_0_rgba(255,255,255,0.03)] backdrop-blur-sm"
        style={{ minHeight: '60%' }}
      >
      ...
      <div className="h-48 flex gap-4 shrink-0">
        <div className="flex-[2] bg-gradient-to-br from-slate-800/10 to-slate-900/20 rounded-xl p-4 shadow-[0_0_25px_rgba(0,217,255,0.06),inset_0_1px_0_rgba(255,255,255,0.03)] border border-[#00d9ff]/8 backdrop-blur-sm">
          <div className="h-full bg-black/15 rounded-lg p-3 border border-slate-700/10 shadow-inner">
        ...
        <div className="flex-[3] bg-gradient-to-br from-slate-800/10 to-slate-900/20 rounded-xl p-4 shadow-[0_0_25px_rgba(0,217,255,0.06),inset_0_1px_0_rgba(255,255,255,0.03)] border border-[#00d9ff]/8 backdrop-blur-sm">
          <div className="h-full bg-black/15 rounded-lg p-3 border border-slate-700/10 shadow-inner">
            {attackSourceInfo ? (
