                    ...
                    <div className="h-44 overflow-hidden bg-slate-800/30 rounded-lg border border-slate-700/50">
                      ...
                      >
                        ...
                        {dashboardData.workTasks.filter(t => t.feedback_status === '未反馈').map((task) => (
                          <div key={`task-unfinished-${task.id}`} className="bg-slate-800/60 hover:bg-slate-700/60 rounded-lg p-3 mb-2 border border-orange-500/30 transition-colors" style={{height: '85px', minHeight: '85px'}}>
                            <div className="flex gap-3 h-full">
                              {/* 左侧标签框 */}
                              <div className="flex-shrink-0">
                                <div className="bg-orange-500 text-white text-xs font-bold px-2 py-1 rounded text-center min-w-[60px]">
                                  {task.type}
                                </div>
                              </div>
                        ...
                        {dashboardData.workTasks.filter(t => t.feedback_status === '未反馈').map((task) => (
                          <div key={`task-unfinished-repeat-${task.id}`} className="bg-slate-800/60 hover:bg-slate-700/60 rounded-lg p-3 mb-2 border border-orange-500/30 transition-colors" style={{height: '85px', minHeight: '85px'}}>
                            <div className="flex gap-3 h-full">
                              {/* 左侧标签框 */}
                              <div className="flex-shrink-0">
                                <div className="bg-orange-500 text-white text-xs font-bold px-2 py-1 rounded text-center min-w-[60px]">
