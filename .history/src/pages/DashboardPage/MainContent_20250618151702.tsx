...
const MainContent: React.FC<MainContentProps> = ({
  ...
  return (
    <section className="flex-grow basis-2/5 bg-gradient-to-br from-[#00d9ff]/[0.02] via-transparent to-[#00d9ff]/[0.01] rounded-lg overflow-hidden p-1 border border-[#00d9ff]/20 shadow-[inset_0_0_25px_rgba(0,217,255,0.04)] flex flex-col gap-2">
      {/* 上方区域 - 地球仪 */}
      <div
        ref={globeContainerRef}
        className="flex-grow bg-gradient-to-br from-[#00d9ff]/[0.03] via-transparent to-[#00d9ff]/[0.01] rounded-md relative overflow-hidden border border-[#00d9ff]/10"
        style={{ minHeight: '60%' }}
      >
      ...
      <div className="h-48 flex gap-2 shrink-0">
        <div className="flex-[2] bg-gradient-to-br from-[#00d9ff]/[0.04] via-transparent to-[#00d9ff]/[0.02] rounded-md p-2 border border-[#00d9ff]/15 shadow-[inset_0_0_8px_rgba(0,217,255,0.03)]">
        ...
        <div className="flex-[3] bg-gradient-to-br from-[#00d9ff]/[0.04] via-transparent to-[#00d9ff]/[0.02] rounded-md p-2 border border-[#00d9ff]/15 shadow-[inset_0_0_8px_rgba(0,217,255,0.03)]">
          <div className="h-full">
            {attackSourceInfo ? (
