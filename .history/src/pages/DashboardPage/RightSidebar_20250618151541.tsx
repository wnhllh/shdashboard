...
const RightSidebar: React.FC<RightSidebarProps> = ({
  ...
  return (
    <section
      className="flex flex-col h-full gap-3 shrink-0 border border-[#00d9ff]/20 rounded-lg p-2 bg-gradient-to-br from-[#00d9ff]/[0.02] via-transparent to-[#00d9ff]/[0.01] shadow-[inset_0_0_15px_rgba(0,217,255,0.04)]"
      style={{ flexBasis: width, maxWidth: width, minWidth: width }}
    >
      {/* 邮件通知 */}
      <EmailNotification />
      <div
        className="bg-gradient-to-br from-[#00d9ff]/[0.03] via-transparent to-[#00d9ff]/[0.01] p-4 rounded-lg flex-grow min-h-0 border border-[#00d9ff]/15 shadow-[inset_0_0_10px_rgba(0,217,255,0.03)]"
        ...
        <div className="overflow-hidden">
          <div className="flex transition-transform duration-500 ease-in-out" style={{ transform: `translateX(${activeTab === 'attack' ? '0%' : '-100%'})` }}>
            ...
            <div className="w-full flex-shrink-0">
              <div className="overflow-hidden">
                <div className="rounded-md overflow-hidden border border-[#00d9ff]/15 max-h-48">
                  <div className="overflow-y-auto max-h-48">
                    <table className="min-w-full text-xs table-fixed">
                      ...
                      <thead className="sticky top-0">
                        <tr className="bg-gradient-to-r from-[#00d9ff]/[0.08] to-[#00d9ff]/[0.04] border-b border-[#00d9ff]/20">
