  ...
  return (
    <section className="flex-grow basis-2/5 bg-gradient-to-b from-slate-900/20 to-black/40 rounded-2xl overflow-hidden p-4 border border-[#00d9ff]/15 shadow-[0_0_40px_rgba(0,217,255,0.08),inset_0_1px_0_rgba(255,255,255,0.05)] backdrop-blur-md relative flex flex-col gap-4">
      ...
      <div className="h-48 flex gap-3 shrink-0">
        <div className="flex-[2] bg-slate-800/40 rounded-lg p-3 shadow-[0_0_15px_rgba(0,217,255,0.1)] border border-[#00d9ff]/20">
          <div className="h-full bg-black/30 rounded-md p-2 border border-slate-700/30">
        ...
        <div className="flex-[3] bg-slate-800/40 rounded-lg p-3 shadow-[0_0_15px_rgba(0,217,255,0.1)] border border-[#00d9ff]/20">
          <div className="h-full bg-black/30 rounded-md p-2 border border-slate-700/30">
            {attackSourceInfo ? (
