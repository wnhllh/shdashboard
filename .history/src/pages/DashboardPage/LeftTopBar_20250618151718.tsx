...
const LeftTopBar: React.FC<LeftTopBarProps> = ({
  ...
  return (
    <section
      ref={sectionRef}
      className="flex flex-col gap-3 shrink-0 bg-gradient-to-br from-[#00d9ff]/[0.02] via-transparent to-[#00d9ff]/[0.01] p-4 rounded-lg overflow-y-auto border border-[#00d9ff]/20 shadow-[inset_0_0_20px_rgba(0,217,255,0.05)]"
