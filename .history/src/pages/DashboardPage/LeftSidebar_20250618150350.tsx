...
const LeftSidebar: React.FC<LeftSidebarProps> = ({ overallStats, attackSourceInfo, width }) => {
  ...
  return (
    <section
      className="bg-gradient-to-b from-slate-900/20 to-black/40 p-4 rounded-2xl overflow-y-auto flex flex-col space-y-4 shrink-0 border border-[#00d9ff]/15 shadow-[0_0_40px_rgba(0,217,255,0.08),inset_0_1px_0_rgba(255,255,255,0.05)] backdrop-blur-md relative"
    ...
    >
      ...
      <div className="bg-gradient-to-br from-slate-800/10 to-slate-900/20 rounded-xl p-4 border border-[#00d9ff]/8 shadow-[0_0_25px_rgba(0,217,255,0.06),inset_0_1px_0_rgba(255,255,255,0.03)] backdrop-blur-sm">
        <div className="mb-3 pb-2 border-b border-[#00d9ff]/15">
          <h3 className="text-sm font-semibold text-[#00d9ff] uppercase tracking-wider flex items-center">
            <span className="w-2 h-2 bg-[#00d9ff] rounded-full mr-2 shadow-[0_0_4px_#00d9ff]"></span>
            真实拦截率
          </h3>
        </div>
        <div className="bg-black/20 rounded-lg p-3 border border-slate-700/15 shadow-inner">
