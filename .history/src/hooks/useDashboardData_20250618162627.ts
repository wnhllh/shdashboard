      ...
      try {
        ...
        const mockProvinceWarnings: ProvinceWarning[] = [
          ...
          },
          {
            ...
            category: 'DDoS攻击',
            level: '中',
            publish_time: new Date(Date.now() - 12 * 60 * 60 * 1000).toISOString(), // 12小时前下发
            deadline_time: new Date(Date.now() - 6 * 60 * 60 * 1000).toISOString(), // 6小时前截止
            creator: '省网络安全中心',
            feedback_person: '赵响应',
            is_closed: true,
          ...
          },
          {
            ...
            category: '钓鱼攻击',
            level: '低',
            publish_time: new Date(Date.now() - 24 * 60 * 60 * 1000).toISOString(), // 24小时前下发
            deadline_time: new Date(Date.now() - 12 * 60 * 60 * 1000).toISOString(), // 12小时前截止
            creator: '市网络安全中心',
            feedback_person: '孙处理',
            is_closed: true,
          ...
          },
          {
            ...
            category: '数据安全',
            level: '高',
            publish_time: new Date(Date.now() - 36 * 60 * 60 * 1000).toISOString(), // 36小时前下发
            deadline_time: new Date(Date.now() - 24 * 60 * 60 * 1000).toISOString(), // 24小时前截止
            creator: '国家网络安全中心',
            feedback_person: '周调查',
            is_closed: true,
