      ...
      try {
        ...
        const mockWorkTasks: WorkTask[] = [
          ...
          },
          {
            ...
            description: '各单位：请于本周四 09:00 前按表格模板报送上周四 00:00 至本周四 00:00 外网封禁 IP 详情。注意：1、请严格按照模板格式填写',
            type: '安全事件',
          ...
          },
          {
            ...
            description: '各单位：为做好网络安全联合防御，及时消除风险隐患，请各单位按照附件《威胁情报（共享至安全）》-第 30 期要求开展相关工作',
            type: '安全事件',
          ...
          },
          {
            ...
            description: '近日发现，麒麟软件有限公司研发的中标麒麟安全邮件服务器系统存在 SQL 注入漏洞，攻击者可利用漏洞读取数据库敏感信息',
            type: '安全事件',
        ...
        const mockWorkNotifications: WorkNotification[] = [
          ...
          },
          {
            ...
            description: '各单位：根据公司数字化工作安排，为提升各单位边界安全设备防护能力，国网信通公司常态化开展全网边界扶防措施验证工作',
            type: '事件公告',
          ...
          },
          {
            ...
            description: '公司各单位：根据国家电网公司 2025 年网络安全实战对抗工作安排，国网信通公司计划组织召开第二期网络安全实战对抗方案总结会',
            type: '事件公告',
          ...
          },
          {
            ...
            description: '各单位：为进一步加强公司网络安全工作，国网数字化部网络安全基础能力提升工作情况制作 5 月公司信息系统网络安全月报',
            type: '其他',
        ...
        const mockAttackSourceWarnings: AttackSourceWarning[] = [
          {
            ...
            description: '6 月 18 日监控发现 64 个外网攻击源对公司多家单位发起攻击行为',
          ...
          },
          {
            ...
            description: '6 月 13 日监控发现 44 个外网攻击源对公司多家单位发起攻击行为',
          ...
          },
          {
            ...
            description: '6 月 11 日监控发现 98 个外网攻击源对公司多家单位的多个外网系统发起攻击',
          ...
          },
          {
            ...
            description: '6 月 6 日监控发现 34 个外网攻击源发起攻击行为',
          ...
          },
          {
            ...
            description: '6 月 4 日监控发现 71 个外网攻击源发起攻击行为',
          ...
          },
          {
            ...
            description: '5 月 30 日监控发现 41 个外网攻击源发起攻击行为',
          ...
          },
          {
            ...
            description: '5 月 28 日监控发现 52 个外网攻击源发起攻击行为',
          ...
          },
          {
            ...
            description: '5 月 23 日监控发现 62 个外网攻击源发起攻击行为',
        ...
        const mockVulnerabilityWarnings: VulnerabilityWarning[] = [
          {
            ...
            name: '方正畅想全媒采编系统密码重置与 SQL 注入漏洞风险预警',
            risk_level: '八级',
          ...
          },
          {
            ...
            name: '使用 BShare 工具的互联网系统存在被劫持风险预警',
            risk_level: '八级',
            publisher: '网络安全分析监控中心',
        ...
        const mockWarningAnnouncements: WarningAnnouncement[] = [
          ...
          },
          {
            ...
            description: '2025-06-10 Apache 发布安全公告，修复 Apache Kafka Client 相关漏洞',
            type: '漏洞公告',
          ...
          },
          {
            ...
            description: '公安情报显示出现以社工手段实施电话诈骗攻击',
            type: '安全事件',
          ...
          },
          {
            ...
            description: '已要求浏览器升级至 v117.86 并采取相应防护措施',
            type: '事件公告',
