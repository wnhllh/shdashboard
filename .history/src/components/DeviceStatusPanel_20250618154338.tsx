    ...
    <div className="relative space-y-4">
      ...
      <div className="relative text-center mb-6">
        ...
        <div className="relative">
          ...
          <p className="text-sm text-slate-400 font-mono">DEVICE STATUS MONITOR</p>
          <div className="mt-2 h-px bg-gradient-to-r from-transparent via-cyan-400 to-transparent"></div>
          {/* 装饰性光点 */}
          <div className="absolute -top-2 left-1/2 transform -translate-x-1/2 w-2 h-2 bg-cyan-400 rounded-full animate-pulse shadow-[0_0_12px_rgba(6,182,212,0.8)]"></div>
        </div>
      </div>
      ...
      <div className="relative pt-4">
        ...
        <div className="text-center mt-2">
          <div className="inline-flex items-center space-x-2 text-xs text-slate-500 font-mono">
