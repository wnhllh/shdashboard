...
const WafStatusComponent: React.FC = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-teal-900/30 via-slate-900/80 to-emerald-900/30 backdrop-blur-sm p-2.5 rounded-lg border border-teal-400/40 shadow-[0_0_15px_rgba(20,184,166,0.15)] overflow-hidden">
      {/* 背景装饰 */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_80%,rgba(20,184,166,0.1),transparent_70%)]"></div>
      ...
      <div className="relative flex items-center justify-between mb-2.5">
        <div className="flex items-center space-x-2">
          <div className="w-5 h-5 rounded bg-teal-500/20 border border-teal-400/50 flex items-center justify-center">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" className="text-teal-400">
        ...
        {wafData.map((device) => (
          <div key={device.name} className={`relative p-2 rounded border transition-all duration-300 ${
            device.status === 'online'
              ? 'bg-teal-950/40 border-teal-400/30 shadow-[0_0_8px_rgba(20,184,166,0.1)]'
            ...
            {device.status === 'online' && (
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xs text-teal-400 font-mono min-w-[20px]">
