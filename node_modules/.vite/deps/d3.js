...
function contains_default3(polygon, point2) {
  ...
  for (var i = 0; i < n; ++i) {
    ...
    if (y1 > y3 !== y0 > y3 && x3 < (x0 - x1) * (y3 - y1) / (y0 - y1) + x1) inside = !inside;
    x0 = x1, y0 = y1;
  }
  return inside;
}
