...
function App() {
  return (
    <div className="w-screen h-screen bg-gradient-to-br from-[#0a192f] via-[#102a43] to-[#061528] text-gray-200 flex flex-col items-stretch overflow-hidden relative">
      {/* Background effects */}
      ...
      <header className="w-full py-4 px-4 text-center shrink-0 bg-[#070e1a]/70 backdrop-blur-md shadow-[0_0_20px_rgba(0,217,255,0.25)] z-10 border-b border-[#1e3a5f]/40">
        <h1 className="text-3xl font-bold tracking-wider text-[#00d9ff] inline-block relative">
          <span className="absolute inset-0 text-[#00d9ff] opacity-30 blur-[3px] animate-pulse">网络安全态势</span>
          <span className="relative z-10 bg-gradient-to-r from-[#00f7ff] via-[#00d9ff] to-[#0088ff] text-transparent bg-clip-text">电力公司网络安全态势</span>
